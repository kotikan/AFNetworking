Pod::Spec.new do |s|
  s.name     = 'KKAFNetworking'
  s.version  = '2.3.1-k'
  s.license  = 'MIT'
  s.summary  = 'A delightful iOS and OS X networking framework.'
  s.homepage = 'https://github.com/kotikan/AFNetworking'
  s.social_media_url = 'https://twitter.com/AFNetworking'
  s.authors  = { 'Mattt Thompson' => 'm@mattt.me' }
  s.source   = { :git => 'https://github.com/kotikan/AFNetworking.git', :tag => "2.3.1-k", :submodules => true }
  s.requires_arc = true
